...
### Bundle
- [中醫門診單](Bundle-BundleTWCM-min.html)：依據中醫門診單(Bundle TWCM)Profile呈現中醫門診單範例
...
- [文件參照範例](DocumentReference-DocumentReferenceTWCM-min.html)：依據文件參照(DocumentReferance TWCM)Profile呈現中醫門診單中文件參照的範例
...
- [藥品資訊範例](Medication-MedicationTWCM-pro.html)：依據藥品(Medication TWCM)Profile呈現中醫門診單中藥品範例

### MedicationRequest
- [藥品請求範例](MedicationRequest-MedicationRequestTWCM-min.html)：依據藥品請求(MedicationRequest TWCM)Profile呈現中醫門診單中藥品請求範例
- [藥品請求範例](MedicationRequest-MedicationRequestTWCM-pro.html)：依據藥品請求(MedicationRequest TWCM)Profile呈現中醫門診單中藥品請求範例

### Observation 
- [血型範例](Observation-ObservationBloodtypeTWCM-min.html)：依據血型(ObservationBloodtype TWCM)Profile呈現中醫門診單中血型的範例
- [教育程度範例](Observation-ObservationEducationLevelTWCM-min.html)：依據教育程度(ObservationEducationLevel TWCM)Profile呈現中醫門診單中教育程度的範例
- [檢驗檢查範例](Observation-ObservationTWCM-min.html)：依據檢驗檢查(Observation TWCM)Profile呈現中醫門診單中檢驗檢查範例
- [檢驗檢查範例](Observation-ObservationTWCM-pro.html)：依據檢驗檢查(Observation TWCM)Profile呈現中醫門診單中檢驗檢查範例
- [職業範例](Observation-ObservationOccupationTWCM-min.html)：依據職業(ObservationOccupation TWCM)Profile呈現中醫門診單中職業的範例
- [生命徵象範例](Observation-ObservationVitalSignTWCM-min.html)：依據生命徵象(ObservationVitalSign TWCM)Profile呈現中醫門診單中生命徵象範例
    - [血壓範例](Observation-obs-bloodPressure-example-TWCM.html)：依據臺灣核心-血壓(TW Core Observation Blood Pressure) Profile呈現血壓範例
    - [脈搏範例](Observation-obs-heartrate-example-TWCM.html)：依據脈搏(ObservationHeartRate TWCM) Profile呈現脈搏範例
...
- [檢驗檢查機構基本資料-捷達世檢驗所](Organization-OrganizationInspectionTWCM-min.html)：依據檢驗檢查機構(OrganizationInspection TWCM)Profile呈現中醫門診單中檢驗檢查機構範例

### Patient 
- [病人基本資料-陳美真](Patient-PatientTWCM-min.html)：依據病人資料(Patient TWCM)Profile呈現中醫門診單中之病人資料範例

### Practitioner
- [健康照護服務提供人員基本資料-張正原](Practitioner-PractitionerTWCM-pro.html)：依據健康照護服務提供人員資料(Practitioner TWCM)Profile呈現中醫門診單中之健康照護服務提供人員資料範例
...
- [服務請求範例](ServiceRequest-ServiceRequestTWCM-pro.html)：依據服務請求(SerciceRequest TWCM)Profile呈現中醫門診單中服務請求的範例
