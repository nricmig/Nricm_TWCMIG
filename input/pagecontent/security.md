...
-   [稽核登錄(Audit Logging)](http://hl7.org/fhir/R4/security.html#audit%20logging)
...
- 對於認證和授權，系統**必須(SHALL)** 支援用於用戶端<-->伺服器互動的[SMART App執行框架(launch framework)](http://www.hl7.org/fhir/smart-app-launch/history.cfml)。注意：FHIR上的SMART規範包括啟用安全決策所需的OAuth 2.0範圍。
